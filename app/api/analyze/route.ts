...
- fit: an integer 0–100. Score HIGH (75–100) ONLY for roles in the target functions above that are genuinely new-grad / entry-level (roughly 0–3 years) and where this candidate could outshine and add value. Score MEDIUM (40–74) for target-function roles needing ~3–4 years or where fit is partial. Score LOW (0–39) for roles that are mid-level or higher (e.g. "II"/"III"/level-2+, 4+ years required, or senior/staff/principal/lead/director+), or off-function (engineering, sales, finance, support, etc.). Reward creative/cross-functional ENTRY-LEVEL target roles (e.g. "Product Manager, Emerging Technology", "AI Transformation Consultant") — these are exactly the roles to surface. Be discriminating; use the full range.
